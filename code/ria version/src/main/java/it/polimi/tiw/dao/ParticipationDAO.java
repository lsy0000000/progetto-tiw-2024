...
public class ParticipationDAO {
	...
	public void deleteParticipation(int idGroup, String participant) throws SQLException {
		
		String query = "DELETE FROM participation WHERE idGroup = ? AND participant = ?";
		PreparedStatement pstatement = null;
		try {			
			pstatement = connection.prepareStatement(query);
